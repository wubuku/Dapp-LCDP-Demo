...
create table day_summary (day_month_year_number integer not null, day_month_year_calendar varchar(20) not null, day_month_number integer not null, day_month_is_leap bit not null, day_number integer not null, day_time_zone varchar(20) not null, off_chain_version bigint not null, id VARCHAR(42), description varchar(255), metadata tinyblob, optional_data tinyblob, version decimal(19,2), created_by varchar(255), updated_by varchar(255), active bit, deleted bit, created_at datetime, updated_at datetime, primary key (day_month_year_number, day_month_year_calendar, day_month_number, day_month_is_leap, day_number, day_time_zone));
...
create table day_summary_event (day_month_year_number integer not null, day_month_year_calendar varchar(20) not null, day_month_number integer not null, day_month_is_leap bit not null, day_number integer not null, day_time_zone varchar(20) not null, off_chain_version bigint not null, event_type varchar(255) not null, id VARCHAR(42), created_by varchar(255), created_at datetime, command_id varchar(255), version decimal(19,2), command_type varchar(50), lob_text varchar(255), primary key (day_month_year_number, day_month_year_calendar, day_month_number, day_month_is_leap, day_number, day_time_zone, off_chain_version));
create table domain_name (domain_name_id_top_level_domain varchar(255) not null, domain_name_id_second_level_domain varchar(255) not null, off_chain_version bigint not null, id VARCHAR(42), expiration_date decimal(19,2), version decimal(19,2), created_by varchar(255), updated_by varchar(255), active bit, deleted bit, created_at datetime, updated_at datetime, primary key (domain_name_id_top_level_domain, domain_name_id_second_level_domain));
create table domain_name_event (domain_name_id_top_level_domain varchar(255) not null, domain_name_id_second_level_domain varchar(255) not null, off_chain_version bigint not null, event_type varchar(255) not null, id VARCHAR(42), created_by varchar(255), created_at datetime, command_id varchar(255), version decimal(19,2), command_type varchar(50), lob_text varchar(255), primary key (domain_name_id_top_level_domain, domain_name_id_second_level_domain, off_chain_version));
...
create table order_event (id VARCHAR(42) not null, off_chain_version bigint not null, event_type varchar(255) not null, created_by varchar(255), created_at datetime, command_id varchar(255), version decimal(19,2), command_type varchar(50), lob_text varchar(255), primary key (id, off_chain_version));
create table order_item (order_item_id_order_id VARCHAR(42) not null, order_item_id_product_id varchar(50) not null, off_chain_version bigint not null, quantity decimal(19,2), item_amount decimal(19,2), created_by varchar(255), updated_by varchar(255), active bit, deleted bit, created_at datetime, updated_at datetime, primary key (order_item_id_order_id, order_item_id_product_id));
...
create table order_t (id varchar(42) not null, off_chain_version bigint not null, total_amount decimal(19,2), version decimal(19,2), created_by varchar(255), updated_by varchar(255), active bit, deleted bit, created_at datetime, updated_at datetime, primary key (id));
create table order_v2 (order_id varchar(50) not null, off_chain_version bigint not null, id VARCHAR(42), total_amount decimal(19,2), estimated_ship_date_month_year_number integer, estimated_ship_date_month_year_calendar varchar(20), estimated_ship_date_month_number integer, estimated_ship_date_month_is_leap bit, estimated_ship_date_number integer, estimated_ship_date_time_zone varchar(20), version decimal(19,2), created_by varchar(255), updated_by varchar(255), active bit, deleted bit, created_at datetime, updated_at datetime, primary key (order_id));
create table order_v2_event (order_id varchar(50) not null, off_chain_version bigint not null, event_type varchar(255) not null, id VARCHAR(42), created_by varchar(255), created_at datetime, command_id varchar(255), version decimal(19,2), command_type varchar(50), lob_text varchar(255), primary key (order_id, off_chain_version));
create table order_v2_item (order_v2_item_id_order_v2_order_id varchar(50) not null, order_v2_item_id_product_id varchar(50) not null, off_chain_version bigint not null, quantity decimal(19,2), item_amount decimal(19,2), created_by varchar(255), updated_by varchar(255), active bit, deleted bit, created_at datetime, updated_at datetime, primary key (order_v2_item_id_order_v2_order_id, order_v2_item_id_product_id));
