...
create table order_event (id VARCHAR(42) not null, version bigint not null, event_type varchar(255) not null, created_by varchar(255), created_at datetime, command_id varchar(255), command_type varchar(50), lob_text varchar(255), primary key (id, version)) type=MyISAM;
...
create table order_item_event (order_item_id_order_id VARCHAR(42) not null, order_item_id_product_id varchar(50) not null, order_version bigint not null, event_type varchar(255) not null, created_by varchar(255), created_at datetime, command_id varchar(255), primary key (order_item_id_order_id, order_item_id_product_id, order_version)) type=MyISAM;
create table order_T (id varchar(42) not null, version bigint, total_amount decimal(19,2), created_by varchar(255), updated_by varchar(255), active bit, deleted bit, created_at datetime, updated_at datetime, primary key (id)) type=MyISAM;
...
create table order_v2_event (order_id varchar(50) not null, version bigint not null, event_type varchar(255) not null, id VARCHAR(42), created_by varchar(255), created_at datetime, command_id varchar(255), command_type varchar(50), lob_text varchar(255), primary key (order_id, version)) type=MyISAM;
...
create table order_v2_item_event (order_v2_item_id_order_v2_order_id varchar(50) not null, order_v2_item_id_product_id varchar(50) not null, order_v2_version bigint not null, event_type varchar(255) not null, created_by varchar(255), created_at datetime, command_id varchar(255), primary key (order_v2_item_id_order_v2_order_id, order_v2_item_id_product_id, order_v2_version)) type=MyISAM;
create table product (product_id varchar(20) not null, version bigint, id VARCHAR(42), name varchar(255), unit_price decimal(19,2), created_by varchar(255), updated_by varchar(255), active bit, created_at datetime, updated_at datetime, command_id varchar(255), primary key (product_id)) type=MyISAM;
