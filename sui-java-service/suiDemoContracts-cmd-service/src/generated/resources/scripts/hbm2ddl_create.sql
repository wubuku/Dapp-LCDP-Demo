...
create table order_event (id VARCHAR(42) not null, off_chain_version bigint not null, event_type varchar(255) not null, created_by varchar(255), created_at datetime, command_id varchar(255), version DECIMAL(20,0), command_type varchar(50), lob_text VARCHAR(2000), primary key (id, off_chain_version)) type=MyISAM;
...
create table order_t (id varchar(42) not null, off_chain_version bigint not null, total_amount DECIMAL(20,0), version DECIMAL(20,0), created_by varchar(255), updated_by varchar(255), active bit, deleted bit, created_at datetime, updated_at datetime, primary key (id)) type=MyISAM;
