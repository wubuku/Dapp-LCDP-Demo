...
public class StaticMethodConstraints {
    ...
    public static void assertStaticVerificationAndMutationMethods() {
        ...
        ReflectUtils.assertStaticMethodIfClassExists(
                    ...
                    new String[]{"_", "registrationPeriod", "owner", "suiTimestamp", "suiTxDigest", "suiEventSeq", "suiPackageId", "suiTransactionModule", "suiSender", "suiType", "nextCursor"}
            );
        ...
        ReflectUtils.assertStaticMethodIfClassExists(
                    ...
                    "mutate",
                    new Class[]{DomainNameState.class, BigInteger.class, String.class, Long.class, String.class, Long.class, String.class, String.class, String.class, String.class, SuiEventId.class, MutationContext.class},
                    new String[]{"_", "renewPeriod", "account", "suiTimestamp", "suiTxDigest", "suiEventSeq", "suiPackageId", "suiTransactionModule", "suiSender", "suiType", "nextCursor"}
            );
        ...
        ReflectUtils.assertStaticMethodIfClassExists(
                    "org.dddml.suidemocontracts.domain.order.CreateLogic",
                    "mutate",
                    new Class[]{OrderState.class, String.class, BigInteger.class, BigInteger.class, BigInteger.class, String.class, Long.class, String.class, Long.class, String.class, String.class, String.class, String.class, SuiEventId.class, MutationContext.class},
                    new String[]{"_", "product", "quantity", "unitPrice", "totalAmount", "owner", "suiTimestamp", "suiTxDigest", "suiEventSeq", "suiPackageId", "suiTransactionModule", "suiSender", "suiType", "nextCursor"}
            );
        ...
        ReflectUtils.assertStaticMethodIfClassExists(
                    "org.dddml.suidemocontracts.domain.order.RemoveItemLogic",
                    "mutate",
                    new Class[]{OrderState.class, String.class, Long.class, String.class, Long.class, String.class, String.class, String.class, String.class, SuiEventId.class, MutationContext.class},
                    new String[]{"_", "productId", "suiTimestamp", "suiTxDigest", "suiEventSeq", "suiPackageId", "suiTransactionModule", "suiSender", "suiType", "nextCursor"}
            );
        ...
        ReflectUtils.assertStaticMethodIfClassExists(
                    "org.dddml.suidemocontracts.domain.order.UpdateItemQuantityLogic",
                    "mutate",
                    new Class[]{OrderState.class, String.class, BigInteger.class, Long.class, String.class, Long.class, String.class, String.class, String.class, String.class, SuiEventId.class, MutationContext.class},
                    new String[]{"_", "productId", "quantity", "suiTimestamp", "suiTxDigest", "suiEventSeq", "suiPackageId", "suiTransactionModule", "suiSender", "suiType", "nextCursor"}
            );
        ...
        ReflectUtils.assertStaticMethodIfClassExists(
                    "org.dddml.suidemocontracts.domain.product.CreateLogic",
                    "mutate",
                    new Class[]{ProductState.class, String.class, BigInteger.class, Long.class, String.class, Long.class, String.class, String.class, String.class, String.class, SuiEventId.class, MutationContext.class},
                    new String[]{"_", "name", "unitPrice", "suiTimestamp", "suiTxDigest", "suiEventSeq", "suiPackageId", "suiTransactionModule", "suiSender", "suiType", "nextCursor"}
            );
        ...
        ReflectUtils.assertStaticMethodIfClassExists(
                    ...
                    new String[]{"_", "estimatedShipDate", "suiTimestamp", "suiTxDigest", "suiEventSeq", "suiPackageId", "suiTransactionModule", "suiSender", "suiType", "nextCursor"}
            );
        ...
        ReflectUtils.assertStaticMethodIfClassExists(
                    "org.dddml.suidemocontracts.domain.daysummary.CreateLogic",
                    "mutate",
                    new Class[]{DaySummaryState.class, String.class, int[].class, String[].class, int[].class, Long.class, String.class, Long.class, String.class, String.class, String.class, String.class, SuiEventId.class, MutationContext.class},
                    new String[]{"_", "description", "metaData", "arrayData", "optionalData", "suiTimestamp", "suiTxDigest", "suiEventSeq", "suiPackageId", "suiTransactionModule", "suiSender", "suiType", "nextCursor"}
            );
