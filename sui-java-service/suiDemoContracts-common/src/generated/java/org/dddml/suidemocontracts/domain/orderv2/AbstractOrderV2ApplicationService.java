...
public abstract class AbstractOrderV2ApplicationService implements OrderV2ApplicationService
{
    ...
    public void when(OrderV2Commands.AddOrderShipGroup c) {
    ...
    public void when(OrderV2Commands.RemoveOrderShipGroupItem c) {
        update(c, ar -> ar.removeOrderShipGroupItem(c.getShipGroupSeqId(), c.getProductId(), c.getOffChainVersion(), c.getCommandId(), c.getRequesterId(), c));
    }

    public void when(OrderV2Commands.RemoveOrderShipGroup c) {
        update(c, ar -> ar.removeOrderShipGroup(c.getShipGroupSeqId(), c.getOffChainVersion(), c.getCommandId(), c.getRequesterId(), c));
    }
    ...
    public Iterable<OrderItemShipGroupAssocSubitemState> getOrderItemShipGroupAssocSubitems(String orderV2OrderId, Integer orderShipGroupShipGroupSeqId, String orderItemShipGroupAssociationProductId, Criterion filter, List<String> orders) {
        return getStateQueryRepository().getOrderItemShipGroupAssocSubitems(orderV2OrderId, orderShipGroupShipGroupSeqId, orderItemShipGroupAssociationProductId, filter, orders);
    }
