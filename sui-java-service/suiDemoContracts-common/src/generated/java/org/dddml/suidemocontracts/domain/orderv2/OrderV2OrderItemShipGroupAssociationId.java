...
public class OrderV2OrderItemShipGroupAssociationId implements Serializable
{
    ...
    public OrderV2OrderItemShipGroupAssociationId()
    {
    }

    public OrderV2OrderItemShipGroupAssociationId(String orderV2OrderId, Integer orderShipGroupShipGroupSeqId, String productId)
    {
        this.orderV2OrderId = orderV2OrderId;
        this.orderShipGroupShipGroupSeqId = orderShipGroupShipGroupSeqId;
        this.productId = productId;
    ...
    public boolean equals(Object obj)
    {
        ...
        OrderV2OrderItemShipGroupAssociationId other = (OrderV2OrderItemShipGroupAssociationId)obj;
        return true 
