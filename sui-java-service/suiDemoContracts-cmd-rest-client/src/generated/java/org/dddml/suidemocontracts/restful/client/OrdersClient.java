...
public interface OrdersClient {
    ...
    Call<OrderEventDto> getEvent(@Path("id") String id, @Path("version") long version);
    ...
    Call<OrderItemStateDto> getOrderItem(@Path("orderId") String orderId, @Path("productId") String productId);
 
    @Headers("Accept: application/json")
    @GET("Orders/{id}/OrderItems")
    Call<List<OrderItemStateDto>> getOrderItems(@Path("id") String id, @Query("sort") String sort, @Query("fields") String fields, @Query("filter") String filter);
    ...
    Call<String> removeItem(@Path("id") String id, @Body OrderCommandDtos.RemoveItemDto content);

    @Headers("Accept: application/json")
    @PUT("Orders/{id}/_commands/UpdateItemQuantity")
    Call<String> updateItemQuantity(@Path("id") String id, @Body OrderCommandDtos.UpdateItemQuantityDto content);
