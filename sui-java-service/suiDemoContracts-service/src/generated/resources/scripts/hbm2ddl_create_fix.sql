...
create table day_summary (day_month_year_number integer not null, day_month_year_calendar varchar(50) not null, day_month_number integer not null, day_month_is_leap bit not null, day_number integer not null, day_time_zone varchar(50) not null, off_chain_version bigint not null, id VARCHAR(66), description varchar(255), metadata tinyblob, optional_data tinyblob, version DECIMAL(20,0), created_by varchar(255), updated_by varchar(255), active bit, deleted bit, created_at datetime, updated_at datetime, primary key (day_month_year_number, day_month_year_calendar, day_month_number, day_month_is_leap, day_number, day_time_zone)) engine=InnoDB;
...
create table product (product_id varchar(20) not null, off_chain_version bigint not null, id VARCHAR(66), name varchar(255), unit_price DECIMAL(20,0), version DECIMAL(20,0), created_by varchar(255), updated_by varchar(255), active bit, deleted bit, created_at datetime, updated_at datetime, primary key (product_id)) engine=InnoDB;
