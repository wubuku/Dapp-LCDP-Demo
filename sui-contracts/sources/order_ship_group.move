...
module sui_demo_contracts::order_ship_group {
    use std::string::String;
    use sui::table;
    use sui::tx_context::TxContext;
    use sui_demo_contracts::order_item_ship_group_association::{Self, OrderItemShipGroupAssociation};
    ...
    public(friend) fun remove_order_item_ship_group_association(order_ship_group: &mut OrderShipGroup, product_id: String): OrderItemShipGroupAssociation {
        ...
        table::remove(&mut order_ship_group.order_item_ship_group_associations, product_id)
    }
