...
module sui_demo_contracts::order_item_ship_group_association {
    use std::string::String;
    use sui::table;
    use sui::tx_context::TxContext;
    use sui_demo_contracts::day::Day;
    use sui_demo_contracts::order_item_ship_group_assoc_subitem::{Self, OrderItemShipGroupAssocSubitem};
    ...
    public(friend) fun add_subitem(order_item_ship_group_association: &mut OrderItemShipGroupAssociation, subitem: OrderItemShipGroupAssocSubitem) {
        ...
        assert!(!table::contains(&order_item_ship_group_association.subitems, key), EIdAlreadyExists);
