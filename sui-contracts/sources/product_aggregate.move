...
module sui_demo_contracts::product_aggregate {
    use std::string::String;
    use sui::tx_context;
    use sui_demo_contracts::product;
    use sui_demo_contracts::product_create_logic;
    use sui_demo_contracts::product_delete_logic;
    use sui_demo_contracts::product_update_logic;
