...
public class HibernateOrderStateQueryRepository implements OrderStateQueryRepository {
    ...
    public OrderItemShipGroupAssociationState getOrderItemShipGroupAssociation(String orderId, Integer orderShipGroupShipGroupSeqId, String productId) {
        OrderItemShipGroupAssociationId entityId = new OrderItemShipGroupAssociationId(orderId, orderShipGroupShipGroupSeqId, productId);
    ...
    public OrderItemShipGroupAssocSubitemState getOrderItemShipGroupAssocSubitem(String orderId, Integer orderShipGroupShipGroupSeqId, String orderItemShipGroupAssociationProductId, Day orderItemShipGroupAssocSubitemDay) {
        OrderItemShipGroupAssocSubitemId entityId = new OrderItemShipGroupAssocSubitemId(orderId, orderShipGroupShipGroupSeqId, orderItemShipGroupAssociationProductId, orderItemShipGroupAssocSubitemDay);
    ...
    @Transactional(readOnly = true)
    public Iterable<OrderItemShipGroupAssocSubitemState> getOrderItemShipGroupAssocSubitems(String orderId, Integer orderShipGroupShipGroupSeqId, String orderItemShipGroupAssociationProductId, org.dddml.support.criterion.Criterion filter, List<String> orders) {
        ...
        org.hibernate.criterion.Junction partIdCondition = org.hibernate.criterion.Restrictions.conjunction()
            ...
            .add(org.hibernate.criterion.Restrictions.eq("orderItemShipGroupAssocSubitemId.orderItemShipGroupAssociationProductId", orderItemShipGroupAssociationProductId))
            ;
        HibernateUtils.criteriaAddFilterAndOrdersAndSetFirstResultAndMaxResults(criteria, filter, orders, 0, Integer.MAX_VALUE);
        return criteria.add(partIdCondition).list();
    }
