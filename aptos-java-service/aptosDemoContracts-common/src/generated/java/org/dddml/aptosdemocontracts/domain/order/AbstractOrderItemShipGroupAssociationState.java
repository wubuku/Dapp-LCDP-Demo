...
import org.dddml.aptosdemocontracts.domain.order.OrderItemShipGroupAssociationEvent.*;
...
public abstract class AbstractOrderItemShipGroupAssociationState implements OrderItemShipGroupAssociationState.SqlOrderItemShipGroupAssociationState, Saveable {
    ...
    public String getProductId() {
        return this.getOrderItemShipGroupAssociationId().getProductId();
    }
        
    public void setProductId(String productId) {
        this.getOrderItemShipGroupAssociationId().setProductId(productId);
    }
    ...
    protected void throwOnWrongEvent(OrderItemShipGroupAssociationEvent event) {
        ...
        String stateEntityIdProductId = this.getOrderItemShipGroupAssociationId().getProductId();
