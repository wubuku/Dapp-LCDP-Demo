...
public abstract class AbstractOrderItemShipGroupAssociationEvent extends AbstractEvent implements OrderItemShipGroupAssociationEvent.SqlOrderItemShipGroupAssociationEvent, AptosEvent.MutableAptosEvent, HasStatus.MutableHasStatus {
    ...
    {
        OrderItemShipGroupAssocSubitemEventId eventId = new OrderItemShipGroupAssocSubitemEventId(this.getOrderItemShipGroupAssociationEventId().getOrderId(), this.getOrderItemShipGroupAssociationEventId().getOrderShipGroupShipGroupSeqId(), this.getOrderItemShipGroupAssociationEventId().getProductId(), 
