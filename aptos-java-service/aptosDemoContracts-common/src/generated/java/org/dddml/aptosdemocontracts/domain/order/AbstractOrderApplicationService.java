...
public abstract class AbstractOrderApplicationService implements OrderApplicationService {
    ...
    public void when(OrderCommands.Create c) {
        update(c, ar -> ar.create(c.getProductId(), c.getQuantity(), c.getOffChainVersion(), c.getCommandId(), c.getRequesterId(), c));
    }
    ...
    public void when(OrderCommands.RemoveOrderShipGroup c) {
    ...
    public OrderItemShipGroupAssociationState getOrderItemShipGroupAssociation(String orderId, Integer orderShipGroupShipGroupSeqId, String productId) {
        return getStateQueryRepository().getOrderItemShipGroupAssociation(orderId, orderShipGroupShipGroupSeqId, productId);
    }
    ...
    public OrderItemShipGroupAssocSubitemState getOrderItemShipGroupAssocSubitem(String orderId, Integer orderShipGroupShipGroupSeqId, String orderItemShipGroupAssociationProductId, Day orderItemShipGroupAssocSubitemDay) {
        return getStateQueryRepository().getOrderItemShipGroupAssocSubitem(orderId, orderShipGroupShipGroupSeqId, orderItemShipGroupAssociationProductId, orderItemShipGroupAssocSubitemDay);
    }

    public Iterable<OrderItemShipGroupAssocSubitemState> getOrderItemShipGroupAssocSubitems(String orderId, Integer orderShipGroupShipGroupSeqId, String orderItemShipGroupAssociationProductId, Criterion filter, List<String> orders) {
        return getStateQueryRepository().getOrderItemShipGroupAssocSubitems(orderId, orderShipGroupShipGroupSeqId, orderItemShipGroupAssociationProductId, filter, orders);
    }
