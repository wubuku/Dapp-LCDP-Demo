...
package org.dddml.aptosdemocontracts.aptos.contract.daysummary;
...
public class DaySummaryCreated {
    ...
    private com.github.wubuku.aptos.bean.Option<String> optionalData;
    ...
    public com.github.wubuku.aptos.bean.Option<String> getOptionalData() {
        return optionalData;
    }

    public void setOptionalData(com.github.wubuku.aptos.bean.Option<String> optionalData) {
